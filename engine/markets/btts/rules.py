"""Reglas y validaciones del mercado: Ambos equipos marcan (BTTS).

Mismo criterio de confiabilidad que córners y goles: el índice es CONFIABLE
solo si el LOCAL tiene al menos MIN_PARTIDOS_CONFIABLE partidos DE LOCAL y el
VISITANTE al menos MIN_PARTIDOS_CONFIABLE partidos DE VISITANTE.
