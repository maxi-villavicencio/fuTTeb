"""Reglas y validaciones del mercado: Goles.

Mismo criterio de confiabilidad que córners: el índice es CONFIABLE solo si
    - el LOCAL tiene al menos MIN_PARTIDOS_CONFIABLE partidos DE LOCAL, y
    - el VISITANTE al menos MIN_PARTIDOS_CONFIABLE partidos DE VISITANTE.

Si no se cumple, NO rompe ni cambia el cálculo: marca confiable=False y devuelve
una advertencia que dice cuántos partidos tiene cada equipo.
"""
...
def validar_confiabilidad(
    ...
    Returns:
        (advertencias, confiable): advertencias en español; confiable=False si
        algún equipo no llega al umbral.
    """
